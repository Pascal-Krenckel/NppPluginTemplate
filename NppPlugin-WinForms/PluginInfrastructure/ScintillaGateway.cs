...
using System.Text;
using static ___NppPlugin___.PluginInfrastructure.Win32;
...
/// </summary>
public class ScintillaGateway(nint scintilla) : IScintillaGateway
{
    static ScintillaGateway? instance = null;
    internal static ScintillaGateway Instance
    {
        get
        {
            instance ??= new ScintillaGateway(PluginBase.GetCurrentScintilla());
            return instance;
        }
    ...
    private readonly nint scintilla = scintilla;
    ...
    {
        nint res = Win32.SendMessage(scintilla, SciMsg.SCI_GETLENGTH, Unused, Unused);
        return (int)res;
    }
