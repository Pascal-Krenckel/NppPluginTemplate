...
internal class BOMDetector
{
    ...
    {
        // Analyze the BOM
        if (bom.Length >= 3 && bom[0] == 0x2b && bom[1] == 0x2f && bom[2] == 0x76)
            return BOM.UTF7;
        ...
        if (bom.Length >= 2 && bom[0] == 0xfe && bom[1] == 0xff)
            return BOM.UTF16BE;
        if (bom.Length >= 4 && bom[0] == 0xff && bom[1] == 0xfe && bom[2] == 0 && bom[3] == 0)
            return BOM.UTF32LE;
        if (bom.Length >= 4 && bom[0] == 0 && bom[1] == 0 && bom[2] == 0xfe && bom[3] == 0xff)
            return BOM.UTF32BE;
