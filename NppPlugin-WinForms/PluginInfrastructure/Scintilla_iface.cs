...
public struct ScNotification
{
    ...
    /// </summary>
    public readonly char Character => (char)character;
}
...
public class TextToFind : IDisposable
{
    ...
    public nint NativePointer { get { InitNativeStruct(); return _ptrSciTextToFind; } }
    public string Text { set { FreeNativeString(); _sciTextToFind.lpstrText = Marshal.StringToHGlobalAnsi(value); } }
    public CharacterRange Range { get { ReadNativeStruct(); return _sciTextToFind.chrg; } set { _sciTextToFind.chrg = value; InitNativeStruct(); } }

    private void InitNativeStruct()
    {
        if (_ptrSciTextToFind == nint.Zero)
            _ptrSciTextToFind = Marshal.AllocHGlobal(Marshal.SizeOf<Sci_TextToFind>());
    ...
    private void FreeNativeString()
    {
        if (_sciTextToFind.lpstrText != nint.Zero)
